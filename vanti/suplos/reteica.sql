...
SELECT 
  ...
  "De acuerdo con el artículo 10 del decreto 836/91 los Certificados expedidos por computador no requieren Firma Autógrafa" AS RESOLUCION
FROM
...
SELECT 
    ...
    , EXTRACT(MONTH FROM FECHA_CONT) AS PERIODO
    , "BOGOTA DC" AS CIUDAD_PAGO
    , "BOGOTA DC" AS CIUDAD_EXPEDIDO
    , 0 AS BANCO_PAGO
    , 0 AS INDICADOR_ICA
    , 0 AS FECHA_EXPEDICION
    , RESOLUCION AS RESOLUCION
FROM 
    cte
WHERE TIPO_RETENCION NOT IN ('GA', 'GE', 'GB')
AND TIPO_RETENCION BETWEEN 'AA' AND 'ZZ'
